...
from sdap.analysis.NexusHandler import SparkHandler, nexus_handler
from sdap.analysis.algorithms.doms import config as edge_endpoints
from sdap.analysis.algorithms.doms import values as doms_values
from sdap.analysis.algorithms.doms.BaseDomsHandler import DomsQueryResults
from sdap.analysis.algorithms.doms.ResultsStorage import ResultsStorage
from sdap.analysis.webmodel import NexusProcessingException
...
def match_tile_to_point_generator(tile_service, tile_id, m_tree, edge_results, search_domain_bounding_wkt,
    ...
    from sdap.algorithms_spark.Matchup import DomsPoint  # Must import DomsPoint or Spark complains
