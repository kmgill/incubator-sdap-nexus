...
from sdap.NexusHandler import nexus_handler
from sdap.algorithms.doms import config as edge_endpoints
from sdap.webmodel import NexusProcessingException, NoDataException
...
def query_edge(dataset, variable, startTime, endTime, bbox, platform, depth_min, depth_max, session, itemsPerPage=1000,
    ...
    log = logging.getLogger('sdap.algorithms.doms.insitusubset.query_edge')
    try:
